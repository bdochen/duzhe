...
# 通过CSS找到新闻标签
#news = r.html.find('div.new-list > div > ul > li')  效果一样
#news = r.html.find('div.new-list > div > ul > li > span > a')
#news = r.html.find('div.block.new-list-1 > ul > li > span > a')
    ...
    try:
        ...
        for qi_list_article in qi_list_article_list:
           ...
           #print(title_url)
            ...
            article_contents = title_html.html.find('div.mt20.f14')
